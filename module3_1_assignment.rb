...
class Recipe
    ...
    default_params fields: "image_url, source_url, title", key: ENV["FOOD2FORK_KEY"] #defaults, like API developer key 
    format :json #Tell it which format data comes in
    #q:"search" request parameter 

    def self.for term 
    	#class method called for which takes in a term 
    	get ("/search", query:{q:term})["recipes"]#get is method provided by HTTParty 
